                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" method="post" action="/admin/article">
                            ...
                            <div class="form-group {{ $errors->has('publish_at')?'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input name="publish_at" value="{{ old('publish_at') }}" class="form-control layer-date" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
